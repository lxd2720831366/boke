...
<div style="width:900px;margin:auto;margin-top:20px;">
	<form action="/admin/img" method="get" class="form-inline" style="margin-bottom: 3px;">
	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<td >
				<a href="/admin/img/{{$v->id}}/edit"
				 class="btn btn-warning">修改</a>
				<form action="/admin/img/{{$v->id}}" method="post" style="display: inline-block;">
					{{ csrf_field() }}
					{{ method_field('DELETE') }}
	...
	console.log($.ajaxSetup());
		$(function(){
			$('.buttons a').eq(0).click(function(){
				...
				// 执行删除
				$.post('/admin/img/deleteall',{'ids':ids},function(msg){
